...
class ExperimentBuilder(object):
    ...
    def train_iteration(self, train_sample, sample_idx, epoch_idx, total_losses, current_iter, pbar_train):
        ...
        pbar_train.update(1)
        pbar_train.set_description("training phase {}, iteration {}/{} -> {}".format(self.epoch, self.state['current_iter'] - self.epoch*self.args.total_iter_per_epoch, self.args.total_iter_per_epoch, train_output_update)) #I changed this line
