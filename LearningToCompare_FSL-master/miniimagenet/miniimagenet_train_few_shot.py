...
def main():
    ...
    for episode in range(EPISODE):
        ...
        if (episode+1)%100 == 0:
            ...
            print("episode:",episode+1,"loss",loss.data.item()) # loss.data[0]
        ...
        if episode%5000 == 0:
            ...
            if test_accuracy > last_accuracy:
                ...
                if count > stop_criter:
                    print("Test accuracy is not improved in the last {} testing phases, ending training...".format(stop_criter))
                    break
                else:
                    count += 1
